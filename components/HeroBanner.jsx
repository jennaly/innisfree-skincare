           ...
           <div className="hero min-h-screen" style={{ backgroundImage: `url(${urlFor(heroBanner.image)})` }}>
                ...
                <div className="flex h-full w-full items-center justify-center container mx-auto px-8 mb-40">
                    ...
                    <div className="mt-8 flex flex-col space-y-3 sm:-mx-2 sm:flex-row sm:justify-center sm:space-y-0">
                        <Link href="">
                            <button type="button" className="transform rounded-md bg-green-700 px-8 py-3 text-sm font-medium capitalize tracking-wide text-white transition-colors duration-200 hover:bg-green-600 focus:bg-blue-600 focus:outline-none sm:mx-2">{ heroBanner.buttonText }</button>
                        </Link>
                    </div>
                    </div>
                </div>
